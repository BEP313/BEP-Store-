      ...
      <>
                      ...
                      <div className="col-span-3 sm:col-span-2">
                        ...
                        <div className="mt-1 flex rounded-md shadow-sm">
                          ...
                          <input
                            ...
                            placeholder="ellangpermadi.co.id"
                          />
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="mt-1">
                        <textarea
                          ...
                          placeholder="silahkan tulis apa yang sedang anda lakukan!!"
                          defaultValue={''}
                        />
                      </div>
                      <p className="mt-2 text-sm text-gray-500">
                        silahkan klik simpan jika semuanya sudah anda isi!.
                      </p>
                    </div>
        ...
        <div className="mt-10 sm:mt-0">
          <div className="md:grid md:grid-cols-3 md:gap-6">
            <div className="md:col-span-1">
              <div className="px-4 sm:px-0">
                <h3 className="text-lg font-medium leading-6 text-gray-900">Information Pribadi</h3>
                <p className="mt-1 text-sm text-gray-600">gunakan Alamat Email Aktif</p>
              </div>
            </div>
            <div className="mt-5 md:mt-0 md:col-span-2">
              <form action="#" method="POST">
                    ...
                    <div className="grid grid-cols-6 gap-6">
                      ...
                      <div className="col-span-6 sm:col-span-4">
                        ...
                        <input
                          ...
                          autoComplete="email"
                          className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                          placeholder="ellangpermadi@yahoo.com"
                        />
                      </div>
