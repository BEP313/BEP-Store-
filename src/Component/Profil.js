  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-5 8a2 2 0 100-4 2 2 0 000 4zm0 0c1.306 0 2.417.835 2.83 2M9 14a3.001 3.001 0 00-2.83 2M15 11h3m-3 4h2" />
            ...
            <h1 class="mx-3 text-lg font-semibold text-white">CEO Company</h1>
        </div>

        <div class="px-6 py-4">
            <h1 class="text-xl font-semibold text-gray-800 dark:text-white">Bagus Ellang Permadi</h1>

            <p class="py-2 text-gray-700 dark:text-gray-400">CEO BEP Store.</p>
            ...
            <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                ...
                <h1 class="px-2 text-sm">BEP Store</h1>
            </div>
            ...
            <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                ...
                <h1 class="px-2 text-sm">Kroya,Cilacap</h1>
            </div>
            ...
            <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                ...
                <h1 class="px-2 text-sm">ellangpermadi@yahoo.com</h1>
            </div>
        </div>
        </div>
